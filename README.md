About alphatwirl-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/alphatwirl-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/alphatwirl/alphatwirl

Documentation: https://github.com/alphatwirl/alphatwirl#alphatwirl
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6362&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/alphatwirl-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `alphatwirl` can be installed with `conda`:
...
```
mamba install alphatwirl
```

It is possible to list all of the versions of `alphatwirl` available on your platform with `conda`:
...
```
mamba search alphatwirl --channel conda-forge
```
...
mamba repoquery search alphatwirl --channel conda-forge

# List packages depending on `alphatwirl`:
mamba repoquery whoneeds alphatwirl --channel conda-forge

# List dependencies of `alphatwirl`:
mamba repoquery depends alphatwirl --channel conda-forge
```
